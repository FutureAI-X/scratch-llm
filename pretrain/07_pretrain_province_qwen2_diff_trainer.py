...
from model_define.model_qwen_diff.configuration_qwen2 import Qwen2Config
from model_define.model_qwen_diff.modeling_qwen2 import Qwen2ForCausalLM
...
model_save_path = "qwen2-diff-province-city" if dataset_type == "city" else "qwen2-diff-province-intro"
...
training_args = TrainingArguments(
    ...
    num_train_epochs=50,  # 训练的总轮数（epoch），即整个数据集会被遍历 50 次。
