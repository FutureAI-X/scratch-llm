...
"""
dataset_type = "city"
model_save_name = "qwen2-diff-province-city" if dataset_type == "city" else "qwen2-diff-province-intro"
...
"""
model_path = f"../checkpoint_folder/checkpoint_province/{model_save_name}/checkpoint-1650"
